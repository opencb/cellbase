var genesTablePagination = myApp.controller('genesTablePagination', ['$scope', 'mySharedService', 'CellbaseService', function ($scope, mySharedService, CellbaseService) {
...
genesTablePagination.$inject = ['$scope', 'mySharedService'];
