...
myApp.directive('transcriptsGrid', function () {    //cambia -letra por letraMayuscula
    return {   //se devuelve a si mismo como un objeto
        ...
        templateUrl: './views/widgets/transcripts-grid.html',//... le pasariamos el fichero donde se encuentra lo que queremos reemplazar
