...
public class VariationClientTest {
    ...
    public void count() throws Exception {
        ...
        assertEquals("Number of returned variants do not match", 154390842, count.firstResult().longValue());
    }
    ...
    public void getAnnotations() throws Exception {
        ...
        annotations = cellBaseClient.getVariationClient()
                .getAnnotations(idString, new QueryOptions("numThreads", 4));
        assertEquals(100, annotations.getResponse().size());
