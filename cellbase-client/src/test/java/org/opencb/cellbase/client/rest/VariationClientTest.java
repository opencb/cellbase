...
public class VariationClientTest {
    ...
    public void getAnnotations() throws Exception {
        QueryResponse<VariantAnnotation> annotationsGet = cellBaseClient.getVariationClient().getAnnotations("19:45411941:T:C, 14:38679764:-:GATCTG", null);
        ...
        annotationsGet = cellBaseClient.getVariationClient()
                .getAnnotations(idString, new QueryOptions("numThreads", 4));
        assertEquals(100, annotationsGet.getResponse().size());

        QueryResponse<VariantAnnotation> annotationsPost = cellBaseClient.getVariationClient()
