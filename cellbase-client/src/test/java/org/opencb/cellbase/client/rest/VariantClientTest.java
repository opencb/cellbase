...
public class VariantClientTest {
    ...
    public void getAnnotations() throws Exception {
        ...
        CellBaseDataResponse<VariantAnnotation> annotationsGet = cellBaseClient.getVariantClient().getAnnotationByVariantIds("19"
                + ":44908684:T:C", null);
...
//    }
    ...
    public void get() throws Exception {
        CellBaseDataResponse<Variant> variation = cellBaseClient.getVariationClient().get(Collections.singletonList("rs666"), null);
        assertNotNull(variation.firstResult(), "This variation should exist");
    }

    @Test
    public void getAllConsequenceTypes() throws Exception {
        CellBaseDataResponse<String> response = cellBaseClient.getVariationClient().getAllConsequenceTypes(new Query());
    ...
    public void getConsequenceTypeById() throws Exception {
        CellBaseDataResponse<String> stringCellBaseDataResponse = cellBaseClient.getVariationClient().getConsequenceTypeById("rs6661", null);
