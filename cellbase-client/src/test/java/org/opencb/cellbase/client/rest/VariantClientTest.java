...
public class VariantClientTest {
    ...
    public void getAnnotations() throws Exception {
        ...
        assertEquals(101, annotationsGet.getResponse().size());

        QueryResponse<VariantAnnotation> annotationsPost = cellBaseClient37.getVariantClient()
        ...
        Set<VariantAnnotation> getAnnotationSet = new HashSet<>(annotationsGet.getResponse().stream()
                .map(queryResult -> (queryResult.getNumResults() > 0 ? queryResult.getResult().get(0) : null))
