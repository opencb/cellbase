...
public class GenomicRegionClientTest {
    ...
    public void getVariation() throws Exception {
        ...
        assertEquals("Number of variations do not match for 3:555-77777", 1258, variantQueryResponse.getResponse().get(0).getResult().size());
        assertEquals("Number of variations do not match for 11:58888-198888", 2753, variantQueryResponse.getResponse().get(1).getResult().size());
    }
