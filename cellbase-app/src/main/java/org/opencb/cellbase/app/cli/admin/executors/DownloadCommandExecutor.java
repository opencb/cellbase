            ...
            for (String data : dataList) {
                switch (data) {
                    ...
                    case PROTEIN_FUNCTIONAL_PREDICTION_DATA:
                        logger.info("Protein functional prediction data (Sift and PolyPhen) is downloaded from Perl script");
                        downloader = null;
                        break;
                    case REVEL_DATA:
                        downloader = new RevelDownloadManager(species, assembly, outputDirectory, configuration);
                        break;
                    case ALPHAMISSENSE_DATA:
                        downloader = new AlphaMissenseDownloadManager(species, assembly, outputDirectory, configuration);
                        break;
                    default:
