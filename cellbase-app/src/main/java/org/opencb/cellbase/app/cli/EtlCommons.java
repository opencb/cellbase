...
public class EtlCommons {
    ...
    public static final String CLINVAR_XML_FILE = "ClinVarFullRelease_2017-07.xml.gz";
    ...
    public static final String ONTOLOGIES_FOLDER = "ontologies";
    ...
    public static final String ONTOLOGIES_JSON = "ontologies";
