...
//            }
    ...
    private CellBaseParser buildGenomeSequence() {
        ...
        CellBaseSerializer serializer = new CellBaseJsonSerializer(output, "genome_sequence");
    ...
    private CellBaseParser buildGene() {
        ...
        CellBaseSerializer serializer = new CellBaseJsonSerializer(output, "gene");
    ...
    private CellBaseParser buildVariation() {
        ...
        CellBaseFileSerializer serializer = new CellBaseJsonSerializer(output);
...
//    }
    ...
    private CellBaseParser buildRegulatoryRegion() {
        ...
        CellBaseSerializer serializer = new CellBaseJsonSerializer(output, "regulatory_region");
...
//        checkMandatoryOption("species", species);
        CellBaseSerializer serializer = new CellBaseJsonSerializer(output, "protein");
    ...
    private CellBaseParser getInteractionParser()  {
        ...
        CellBaseSerializer serializer = new CellBaseJsonSerializer(output, "protein_protein_interaction");
...
//        return new DrugParser(drugFile, serializer);
    ...
    private CellBaseParser buildClinvar() {
        ...
        CellBaseSerializer serializer = new CellBaseJsonSerializer(output, "clinvar");
    ...
    private CellBaseParser buildCosmic()  {
        ...
        CellBaseSerializer serializer = new CellBaseJsonSerializer(output, "cosmic");
    ...
    private CellBaseParser buildGwas() throws IOException {
        ...
        CellBaseSerializer serializer = new CellBaseJsonSerializer(output, "gwas");
