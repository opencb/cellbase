...
public class CliOptionsParser {
    ...
    public class DownloadCommandOptions {
        ...
        @Parameter(names = {"-d", "--data"}, description = "Comma separated list of data to download: genome, gene, gene_disease_association, variation, variation_functional_score, regulation, protein, conservation, clinical, repeats and . 'all' to download everything", required = true, arity = 1)
        public String data;
