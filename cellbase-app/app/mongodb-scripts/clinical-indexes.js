...
db.getCollection('clinical').ensureIndex({'chromosome': 1, 'start': 1, 'end': 1})
...
db.getCollection('clinical').ensureIndex({'_phenotypes': 'text'})
db.getCollection('clinical').ensureIndex({'source': 1})
...
db.getCollection('clinical').ensureIndex({'primarySite': 'text'})
db.getCollection('clinical').ensureIndex({'siteSubtype': 'text'})
db.getCollection('clinical').ensureIndex({'primaryHistology': 'text'})
db.getCollection('clinical').ensureIndex({'histologySubtype': 'text'})
db.getCollection('clinical').ensureIndex({'studies.traits.diseaseTrait': 'text'})
