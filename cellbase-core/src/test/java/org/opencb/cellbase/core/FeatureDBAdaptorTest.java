...
public class FeatureDBAdaptorTest {

    CellBaseConfiguration cellBaseConfiguration;

    @Before
    public void setUp() throws Exception {
        cellBaseConfiguration = CellBaseConfiguration.load(FeatureDBAdaptorTest.class.getResourceAsStream("/cellBaseProperties_test.json"));
    }
