...
//    public List<GenomicVariantConsequenceType> getAllConsequenceTypeByVariantPrivate(List<GenomicVariant> variants, Set<String> excludeSet, Session session) {
    public List<GenomicVariantConsequenceType> getAllConsequenceTypeByVariantPrivate(GenomicVariant variant, List<Gene> genes, List<RegulatoryRegion> regulatoryRegions) {
