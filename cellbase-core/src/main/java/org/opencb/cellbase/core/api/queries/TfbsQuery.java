...
public class TfbsQuery extends AbstractQuery {
    ...
    public TfbsQuery(Map<String, String> params) throws QueryException {
        super(params);
    }

    private TfbsQuery(Builder builder) {
    ...
    public TfbsQuery setRegions(List<Region> regions) {
    ...
    public static final class Builder {
        ...
        public TfbsQuery build() {
            return new TfbsQuery(this);
        }
    }
}
