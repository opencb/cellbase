...
public class EtlCommons {
    ...
    public static final String CLINVAR_XML_FILE = "ClinVarFullRelease_2022-02.xml.gz";
    ...
    public static final String GWAS_FILE = "gwas-catalog-associations_ontology-annotated.tsv"; //"gwas_catalog.tsv";
