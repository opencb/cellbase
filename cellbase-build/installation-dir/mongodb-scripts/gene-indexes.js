...
db.getCollection('gene').ensureIndex({'transcripts.chromosome': 1})
db.getCollection('gene').ensureIndex({'transcripts.xrefs.id': 1})
db.getCollection('gene').ensureIndex({'transcripts.xrefs.dbName': 1})
db.getCollection('gene').ensureIndex({'transcripts.xrefs.dbNameShort': 1})
db.getCollection('gene').ensureIndex({'transcripts.exons.id': 1})
db.getCollection('gene').ensureIndex({'transcripts.exons.chromosome': 1})