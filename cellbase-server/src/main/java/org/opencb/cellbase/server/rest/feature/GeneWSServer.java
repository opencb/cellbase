...
//    }
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "transcripts.supportLevel",
            ...
            @ApiImplicitParam(name = "transcripts.tfbs.id", value = ParamConstants.TRANSCRIPT_TFBS_IDS,
                    required = false, dataType = "java.util.List", paramType = "query"),
            @ApiImplicitParam(name = "transcripts.tfbs.pfmId", value = ParamConstants.TRANSCRIPT_TFBS_PFMIDS,
                    required = false, dataType = "java.util.List", paramType = "query"),
            @ApiImplicitParam(name = "transcripts.tfbs.transcriptionFactors",
                    value = ParamConstants.TRANSCRIPT_TRANSCRIPTION_FACTORS,
                    required = false, dataType = "java.util.List", paramType = "query"),
            @ApiImplicitParam(name = "transcripts.annotation.ontologies.id", value = ParamConstants.ONTOLOGY_IDS,
                    required = false, dataType = "string", paramType = "query"),
            @ApiImplicitParam(name = "annotation.diseases.id", value = ParamConstants.ANNOTATION_DISEASES_IDS,
                    required = false, dataType = "java.util.List", paramType = "query"),
            @ApiImplicitParam(name = "annotation.diseases.name", value = ParamConstants.ANNOTATION_DISEASES_NAMES,
            ...
            @ApiImplicitParam(name = "annotation.drugs.name", value = ParamConstants.ANNOTATION_DRUGS_NAME,
                    required = false, dataType = "java.util.List", paramType = "query"),
            @ApiImplicitParam(name = "annotation.constraints.name",
                    required = false, allowableValues="exac_oe_lof,exac_pLI,oe_lof,oe_mis,oe_syn",
                    dataType = "java.util.List", paramType = "query"),
            @ApiImplicitParam(name = "annotation.constraints.value",
                    value = ParamConstants.ANNOTATION_CONSTRAINTS_VALUE,
                    required = false, dataType = "java.util.List", paramType = "query"),
            @ApiImplicitParam(name = "annotation.targets",
