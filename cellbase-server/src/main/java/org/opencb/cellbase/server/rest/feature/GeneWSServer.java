...
//    }
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "biotype",  value = ParamConstants.GENE_BIOTYPES,
                    required = false, dataType = "java.util.List", paramType = "query"),
            @ApiImplicitParam(name = "transcriptsBiotype", value = ParamConstants.TRANSCRIPT_BIOTYPES,
                    required = false, dataType = "java.util.List", paramType = "query"),
            @ApiImplicitParam(name = "transcriptsXrefs", value = ParamConstants.TRANSCRIPT_XREFS,
                    required = false, dataType = "java.util.List", paramType = "query"),
            @ApiImplicitParam(name = "transcriptsId", value = ParamConstants.TRANSCRIPT_ENSEMBL_IDS,
                    required = false, dataType = "java.util.List", paramType = "query"),
            @ApiImplicitParam(name = "transcriptsName", value = ParamConstants.TRANSCRIPT_NAMES,
                    required = false, dataType = "java.util.List", paramType = "query"),
            @ApiImplicitParam(name = "transcriptsAnnotationFlags", value = ParamConstants.TRANSCRIPT_ANNOTATION_FLAGS,
                    required = false, dataType = "string", paramType = "query"),
            @ApiImplicitParam(name = "transcriptsSupportLevel",
                    value = ParamConstants.TRANSCRIPT_SUPPORT_LEVEL,
                    required = false, allowableValues="1,2,3,4,5,NA",
                    dataType = "java.util.List", paramType = "query"),
            @ApiImplicitParam(name = "transcriptsTfbsId", value = ParamConstants.TRANSCRIPT_TFBS_IDS,
                    required = false, dataType = "java.util.List", paramType = "query"),
            @ApiImplicitParam(name = "transcriptsTfbsPfmId", value = ParamConstants.TRANSCRIPT_TFBS_PFMIDS,
                    required = false, dataType = "java.util.List", paramType = "query"),
            @ApiImplicitParam(name = "transcriptsTfbsTranscriptionFactors",
                    value = ParamConstants.TRANSCRIPT_TRANSCRIPTION_FACTORS,
                    required = false, dataType = "java.util.List", paramType = "query"),
            @ApiImplicitParam(name = "transcriptAnnotationOntologiesId", value = ParamConstants.ONTOLOGY_IDS,
                    required = false, dataType = "string", paramType = "query"),
            @ApiImplicitParam(name = "annotationDiseasesId", value = ParamConstants.ANNOTATION_DISEASES_IDS,
                    required = false, dataType = "java.util.List", paramType = "query"),
            @ApiImplicitParam(name = "annotationDiseasesName", value = ParamConstants.ANNOTATION_DISEASES_NAMES,
                    required = false, dataType = "java.util.List", paramType = "query"),
            @ApiImplicitParam(name = "annotationExpressionTissue", value = ParamConstants.ANNOTATION_EXPRESSION_TISSUE,
                    required = false, dataType = "java.util.List", paramType = "query"),
            @ApiImplicitParam(name = "annotationExpressionValue", value = ParamConstants.ANNOTATION_EXPRESSION_VALUE,
                    required = false, dataType = "string", paramType = "query"),
            @ApiImplicitParam(name = "annotationDrugsName", value = ParamConstants.ANNOTATION_DRUGS_NAME,
                    required = false, dataType = "java.util.List", paramType = "query"),
            @ApiImplicitParam(name = "annotationConstraintsName",
                    required = false, allowableValues="exac_oe_lof,exac_pLI,oe_lof,oe_mis,oe_syn",
                    dataType = "java.util.List", paramType = "query"),
            @ApiImplicitParam(name = "annotationConstraintsValue",
                    value = ParamConstants.ANNOTATION_CONSTRAINTS_VALUE,
                    required = false, dataType = "java.util.List", paramType = "query"),
            @ApiImplicitParam(name = "annotationTargets",
                    value = ParamConstants.ANNOTATION_TARGETS,
                    required = false, dataType = "java.util.List", paramType = "query"),
            @ApiImplicitParam(name = "mirna", value = ParamConstants.MIRNA,
                    required = false, dataType = "java.util.List", paramType = "query"),
...
//    }
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "biotype", value = ParamConstants.TRANSCRIPT_BIOTYPES,
                    required = false, dataType = "java.util.List", paramType = "query"),
            @ApiImplicitParam(name = "tfbs.id", value = ParamConstants.TRANSCRIPT_TFBS_IDS,
                    required = false, dataType = "java.util.List", paramType = "query"),
