...
# what if you want all the transcription factors bound to those genes
res <- cbGene(object=cb, ids=genes, resource="tfbs")
# to get the data
...
```
Getting annotation for a specific variant/s is just as easy
cbVariant
