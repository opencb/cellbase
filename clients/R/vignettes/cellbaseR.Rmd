...
# trasnscripts data.frame for first geneId
...
data, as well as abiliy to fiter these data by geneId, phenotype, rs, etc…
...
# class CellbaseParam
cbparam <- CellBaseParam(geneId="TET1", genome="GRCh38")
cbparam
...
# CellbaseR utilities
## CreateGeneModel 
A usefull utility for fast building of geneId models, compatible with Gviz
