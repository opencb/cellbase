...
#' run cbSpecies to see avaiable species and their corresponding data
#' @import methods 
#' @slot host A character the default host url for cellllbase webservices
#' @slot version A character the cellbae API version
#' @slot species A charcter should be     a species supported by cellbase
...
#' filterss for the CellbaseQuery
...
#' @export
setMethod("getCellbase", "CellbaseQuery", definition = function(object, 
...
setGeneric("cbClinical", function(object, filters,...)
    standardGeneric("cbClinical"))
...
#' \url{http://bioinfo.hpc.cam.ac.uk/cellbase/webservices/}
#' @export
setMethod("cbClinical", "CellbaseQuery",    definition = function(object, 
    filters=NULL,...) {
    host <- object@host
    species <- object@species
    version <- object@version
    ...
    limit <- "limit=1000"
    filters <- c(genome=genome, genes=genes,region=region,rs=rs,so=so, 
...
###
setGeneric("cbGene", function(object,ids,resource,filter, ...)
    standardGeneric("cbGene"))
...
###
setGeneric("cbRegion", function(object,ids,resource,filters, ...)
    standardGeneric("cbRegion"))
...
#' \url{http://bioinfo.hpc.cam.ac.uk/cellbase/webservices/}
#' @export
setMethod("cbRegion", "CellbaseQuery",    definition = function(object, ids, 
...
###
setGeneric("cbSnp", function(object,ids,resource,filters, ...)
    standardGeneric("cbSnp"))
...
#' \url{http://bioinfo.hpc.cam.ac.uk/cellbase/webservices/}
#' @export
setMethod("cbSnp", "CellbaseQuery",    definition = function(object, ids, 
    resource, filters=NULL,...) {
...
###
setGeneric("cbVariant", function(object,ids,resource,filters=NULL, ...)
    standardGeneric("cbVariant"))
...
#' \url{http://bioinfo.hpc.cam.ac.uk/cellbase/webservices/}
#' @export
setMethod("cbVariant", "CellbaseQuery",    definition = function(object, ids, 
    resource, filters=NULL,...) {
...
###
setGeneric("cbTfbs", function(object,ids,resource,filters=NULL, ...)
    standardGeneric("cbTfbs"))
...
#' \url{http://bioinfo.hpc.cam.ac.uk/cellbase/webservices/}
#' @export
setMethod("cbTfbs", "CellbaseQuery",    definition = function(object, ids, 
    resource, filters=NULL,...) {
...
###
setGeneric("cbTranscript", function(object,ids,resource,filters=NULL, ...)
    standardGeneric("cbTranscript"))
...
###
setGeneric("cbXref", function(object,ids,resource,filters=NULL, ...)
    standardGeneric("cbXref"))
...
#' \url{http://bioinfo.hpc.cam.ac.uk/cellbase/webservices/}
#' @export
setMethod("cbXref", "CellbaseQuery",    definition = function(object, ids, 
    resource,filters=NULL,...) {
    host <- object@host
    species <- object@species
    version <- object@version
...
###
###
setGeneric("cbProtein", function(object,ids,resource,filters=NULL, ...)
    standardGeneric("cbProtein"))
...
#' \url{http://bioinfo.hpc.cam.ac.uk/cellbase/webservices/}
#' @export
setMethod("cbProtein", "CellbaseQuery",    definition = function(object, ids, 
    resource, filters=NULL,...) {
    host <- object@host
    species <- object@species
    version <- object@version
...
###
setGeneric("cbGenomeSequence", function(object,ids,resource,filters=NULL, ...)
    standardGeneric("cbGenomeSequence"))
...
#' \url{http://bioinfo.hpc.cam.ac.uk/cellbase/webservices/}
#' @export
setMethod("cbGenomeSequence", "CellbaseQuery",    definition = function(object
    , ids, resource, filters=NULL,...) {
    host <- object@host
    species <- object@species
    version <- object@version
...
# setMethod("cbMeta", "CellbaseQuery",    definition=function(object, file=NULL
...
setGeneric("cellbaseData", function(object, ...)
    standardGeneric("cellbaseData"))
#' A method to query Clinical data from Cellbase web services
#' @param object an object of class CellbaseQuery
#' @param ids a charcter vector of the ids to be queried
#' @param resource a charcter vector to specify the ids to be queried
...
#'
#' @export
setMethod("cellbaseData", "CellbaseResult",    definition = function(object)
    object@cellbaseData)
