########################################################################################################################
#' @title This class defines the CellBaseR object
#' @details This S4 class holds the default configuration required by CellBaseR methods to connect to the cellbase web 
#' services. By default it is configured to query human data based on the GRCh37 genome assembly. Please, visit
#' https://github.com/opencb/cellbase/wiki and http://bioinfo.hpc.cam.ac.uk/cellbase/webservices/ for more details on
...
setClass("CellBaseR", 
         ...
         prototype = prototype(host="http://bioinfodev.hpc.cam.ac.uk/cellbase-dev-v4.0/webservices/rest/", version = "v4/",
                               species="hsapiens/", batch_size=200, num_threads=8)
)
...
########################################################################################################################
#' @title This Class defines a CellBaseParam object
#' @details This class stores filtering parameters to be used by CellBaseR query methods. Not all the slots will be
