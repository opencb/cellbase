########################################################################################################################
#' A method to query transcriptId data from Cellbase web services.
...
#' @param ids a character vector of the transcriptId ids to be queried, for example, ensemble transccript ID
